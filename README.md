...
- Pipeline GitHub Actions: `.github/workflows/django.yml`
- Verificacoes executadas no CI:
  - `makemigrations --check --dry-run`
  - testes automatizados
  - cobertura com `coverage` e gate minimo de 85%

Comandos locais equivalentes:

```bash
pip install -r requirements-dev.txt
cd simulador_operacional
python manage.py makemigrations --check --dry-run
coverage run --rcfile=../.coveragerc manage.py test app --settings=simulador_operacional.settings_test
...
- Runbook: `docs/RUNBOOK_OPERACAO.md`
- Checklist de release: `docs/RELEASE_CHECKLIST.md`
- Changelog: `CHANGELOG.md`

## Pacote de Release

- Versao atual sugerida: `VERSION`
- Notas da release: `docs/release/RELEASE_NOTES_v1.0.0-rc1.md`
- Plano de commits por bloco: `docs/release/COMMIT_PLAN_v1.0.0-rc1.md`
- Mensagem de commit pronta: `docs/release/COMMIT_MESSAGE_v1.0.0-rc1.txt`
